...
def _gpt2_warning_filter():
    patterns = [
        ...
        (r".*Converting a tensor to a Python boolean might cause the trace to be incorrect.*", [187]),
        ...
        (r".*__floordiv__ is deprecated.*", [66, 67, 68]),
        ...
        (r".*Converting a tensor to a Python float.*", [76])
    ]
