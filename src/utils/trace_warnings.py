...
def _gpt2_warning_filter():
    patterns = [
        ...
        (r".*Converting a tensor to a Python boolean might cause the trace to be incorrect.*", [334, 337, 635, 637]),
        ...
        (r".*Iterating over a tensor might cause the trace to be incorrect.*", [368]),
        ...
        (r".*Converting a tensor to a Python float.*", [171])
